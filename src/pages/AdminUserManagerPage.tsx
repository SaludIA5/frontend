        ...
        <>
            ...
            {loading ? (
                ...
                <ul className="px-4 md:px-8 lg:px-16">
                    <div className="grid grid-cols-[1fr_2fr_2fr_2fr_1fr_1fr_1fr_2fr] gap-4 px-4 py-2 font-semibold">
                        <p>ID</p>
                        <p>Nombre</p>
                        <p>RUT</p>
                        <p>Email</p>
                    ...
                    {users.map((user) => {
                        return (
                            ...
                            >
                                <div className="grid grid-cols-[1fr_2fr_2fr_2fr_1fr_1fr_1fr_2fr] gap-4 items-center">
                                    <p>{user.id}</p>
                                    <p>{user.name}</p>
