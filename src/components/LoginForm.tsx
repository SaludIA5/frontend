...
export default function LoginForm({ onSuccess }: { onSuccess?: () => void }) {
    ...
    return (
        <form onSubmit={handleSubmit} className="space-y-4 text-left">
            ...
            <button type="submit" disabled={isLoading} className="w-full bg-blue-600 hover:bg-blue-700 disabled:bg-blue-400 text-white font-bold py-2 px-4 rounded-md transition-colors">
